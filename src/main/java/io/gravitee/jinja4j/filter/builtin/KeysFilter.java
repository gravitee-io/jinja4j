...
public final class KeysFilter implements NamedFilter {

  public static final KeysFilter INSTANCE = new KeysFilter();
  ...
  public Value apply(Value v, List<Value> args, Map<String, Value> kwargs, SourceLocation loc) {
    ...
    throw new TemplateException("keys() requires a mapping", loc);
  }
}
