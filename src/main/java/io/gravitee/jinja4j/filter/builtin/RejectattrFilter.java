...
/** Reject lv.items() by applying a named test to one of their attributes. */
public final class RejectattrFilter implements NamedFilter {

  public static final RejectattrFilter INSTANCE = new RejectattrFilter();

  private RejectattrFilter() {}
