...
/** Mark a string as safe (not subject to auto-escaping). */
public final class SafeFilter implements NamedFilter {

  public static final SafeFilter INSTANCE = new SafeFilter();
  ...
  public Value apply(Value v, List<Value> args, Map<String, Value> kwargs, SourceLocation loc) {
    return new Value.SafeStringVal(v.asString());
  }
}
