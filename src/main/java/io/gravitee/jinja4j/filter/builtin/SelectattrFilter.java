...
/** Select lv.items() by applying a named test to one of their attributes. */
public final class SelectattrFilter implements NamedFilter {

  public static final SelectattrFilter INSTANCE = new SelectattrFilter();

  private SelectattrFilter() {}
