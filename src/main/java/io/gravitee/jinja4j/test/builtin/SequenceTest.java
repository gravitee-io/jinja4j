...
/** Tests whether a value is a sequence (list). */
public final class SequenceTest implements NamedTest {

  public static final SequenceTest INSTANCE = new SequenceTest();
