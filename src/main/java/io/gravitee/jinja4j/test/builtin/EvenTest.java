...
/** Tests whether an integer value is even. */
public final class EvenTest implements NamedTest {

  public static final EvenTest INSTANCE = new EvenTest();
  ...
  public boolean test(Value value, List<Value> args, SourceLocation loc) {
    return value.isInteger() && value.asLong() % 2 == 0;
  }
}
