...
/** Tests whether a value is a mapping (dict). */
public final class MappingTest implements NamedTest {

  public static final MappingTest INSTANCE = new MappingTest();
