...
/** Equality test. Aliased as {@code equalto} and {@code ==}. */
public final class EqTest implements NamedTest {

  public static final EqTest INSTANCE = new EqTest();
  ...
  public boolean test(Value value, List<Value> args, SourceLocation loc) {
    ...
    return value.equals(args.getFirst());
  }
}
