...
/** Tests whether a value is None (null). */
public final class NoneTest implements NamedTest {

  public static final NoneTest INSTANCE = new NoneTest();
  ...
  public boolean test(Value value, List<Value> args, SourceLocation loc) {
    return value instanceof Value.NullVal;
  }
}
