...
/** Tests whether a value is a number (int or float). */
public final class NumberTest implements NamedTest {

  public static final NumberTest INSTANCE = new NumberTest();
