...
/** Tests whether a value is undefined. */
public final class UndefinedTest implements NamedTest {

  public static final UndefinedTest INSTANCE = new UndefinedTest();

  private UndefinedTest() {}
